...
class DemoData {
  static final List<UserData> _users = [
    ...
    UserData('assets/images/roma.jpeg',
        'Привет, меня зовут Рома. Я очень люблю программировать приложения на Flutter! С недавнего времени являюсь участником команды Flutter в компании Effective =)'),
